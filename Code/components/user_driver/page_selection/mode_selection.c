...
e_MODE_SELECTOR get_current_mode_selection(void)
{
    ...
    if ((gpio_get_level(GPIO_USER_MODE_2) == 0) && (gpio_get_level(GPIO_USER_MODE_3) == 1))
    {
        _mode = kMODE_TOP;
    }
    if ((gpio_get_level(GPIO_USER_MODE_2) == 1) && (gpio_get_level(GPIO_USER_MODE_3) == 1))
    {
        _mode = kMODE_MIDDLE;
    }
    else if ((gpio_get_level(GPIO_USER_MODE_2) == 1) && (gpio_get_level(GPIO_USER_MODE_3) == 0))
    {
        _mode = kMODE_BOTTOM;
    }
    else
